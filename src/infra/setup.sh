...
az ad app federated-credential create \
   ...
   --parameters "{\"name\":\"id-deployment-principal\",\"issuer\":\"https://token.actions.githubusercontent.com\",\"subject\":\"repo:${GITHUB_USER}/vnet:environment:Dev\",\"audiences\":[\"api://AzureADTokenExchange\"]}"
